 ...
 * `--------+-------+------+------+-------+-------------'           `--------------+------+------+------+--------+--------'
 *   |  L1  | ~STEN |  Grv | Left | Right |                                        |  Up  | Down |   [  | Ctrl_R |  L1  |
 *   `-----------------------------------'                                        `-------------------------------------'
 *                                        ,--------------.         ,---------------.
 *                                        |  PgUp | PgDn |         | Home  |  End  |
 *                                 ,------|-------|------|         |-------+-------+--------.
 *                                 |      |       | NONE |         | AltGr |       |        |
 *                                 | Alt  | Enter |------|         |-------| Space | Ctrl_L |
 *                                 |      |       | Supr |         | ~MDIA |       |        |
 *                                 `---------------------'         `------------------------'
 */
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        MO(SYMB),       TT(STEN),     KC_GRV, KC_LEFT,KC_RGHT,
                                                      KC_PGUP,KC_PGDN,
                                                              KC_NO,
                                              KC_LALT,KC_ENT ,M(0),
        // right hand
             ...
             KC_ENT,      KC_B,   KC_M,   KC_W,   KC_V,   KC_Z   , KC_RSFT,
                                  KC_UP,  KC_DOWN,KC_LBRC,KC_RCTL, MO(SYMB),
             KC_HOME, KC_END,
             KC_RALT,
             MO(MDIA),KC_SPC,KC_LCTL
    ),
